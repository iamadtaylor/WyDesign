<?php
    ...
    // If the user's logged in, send them to the dashboard
        ...
        <div class="bd">
            <form action="<?php echo PerchUtil::html(PERCH_LOGINPATH); ?>/" method="post">
                ...
                <?php
                    if (isset($_POST['login']) && @$_POST['username']!='' && @$_POST['password']!='') {
                        if ($CurrentUser->activation_failed) {
                            echo '<p class="alert-failure">' . PerchLang::get('Sorry, your license key isn\'t valid for this domain.') . '</p>';
                        }else{
                ...
                <div<?php if (isset($_POST['login']) && @$_POST['username']=='') echo ' class="error"'; ?>>
                    ...
                    <input type="text" name="username" value="<?php echo PerchUtil::html(@$_POST['username']); ?>" id="username" class="text" />
